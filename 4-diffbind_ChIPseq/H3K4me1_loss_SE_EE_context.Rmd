...
SE_peaks_set16 <- H3K4me1_WTSE_TGSE[H3K4me1_WTSE_TGSE$FDR<=0.05 & abs(H3K4me1_WTSE_TGSE$Fold)>=0.5 & H3K4me1_WTSE_TGSE$SYMBOL %in% set16,]
write.csv(SE_peaks_set16, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/8-multi_omic_integration/overlap/SE_H3K4me1_with_H3K27ac_DNAhm.csv", row.names=F)

length(SE_set16_down <- SE_peaks_set16[SE_peaks_set16$Fold<0,"coord"]) #29
length(SE_set16_up <- SE_peaks_set16[SE_peaks_set16$Fold>0,"coord"]) #4

##Peaks differentially bound in SE - H3K4me1 gain (with H3K27ac, DNAhm changes)
K4me1_Gene_permutation_enrichment(SE_set16_up, background.peaks=H3K4me1_WTSE_TGSE$coord, permutation_number=1000)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 0.88; Depletion 1; Feature: 3' UTR"
...
##Peaks differentially bound in SE - H3K4me1 loss (with H3K4me1, DNAhm changes)
K4me1_Gene_permutation_enrichment(SE_set16_down, background.peaks=H3K4me1_WTSE_TGSE$coord, permutation_number=1000)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: Active Enhancer"
#[1] "Enrichment: 1; Depletion 0.83; Feature: Active Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: Distal Intergenic"
#[1] "Enrichment: 0.63; Depletion 1; Feature: Intron"
#[1] "Enrichment: 1; Depletion 1; Feature: Poised Enhancer"
#[1] "Enrichment: 1; Depletion 1; Feature: Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: Exon"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
...
#"set14" (11 genes)
EE_peaks_set14 <- H3K4me1_WTEE_TGEE[H3K4me1_WTEE_TGEE$FDR<=0.05 & abs(H3K4me1_WTEE_TGEE$Fold)>=0.5 & H3K4me1_WTEE_TGEE$SYMBOL %in% set14,]
write.csv(EE_peaks_set14, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/8-multi_omic_integration/overlap/EE_H3K4me1_with_H3K27ac_DNAhm.csv", row.names=F)

length(EE_set14_down <- EE_peaks_set14[EE_peaks_set14$Fold<0,"coord"]) #16
length(EE_set14_up <- EE_peaks_set14[EE_peaks_set14$Fold>0,"coord"]) #7

##Peaks differentially bound in SE - H3K4me1 gain (with H3K27ac, DNAhm changes)
K4me1_Gene_permutation_enrichment(EE_set14_up, background.peaks=H3K4me1_WTEE_TGEE$coord, permutation_number=1000)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: Active Promoter"
#[1] "Enrichment: 0.2; Depletion 1; Feature: Intron"
#[1] "Enrichment: 1; Depletion 1; Feature: Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: Distal Intergenic"
#[1] "Enrichment: 1; Depletion 1; Feature: Exon"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
...
##Peaks differentially bound in EE - H3K4me1 loss (with H3K4me1, DNAhm changes)
K4me1_Gene_permutation_enrichment(EE_set14_down, background.peaks=H3K4me1_WTEE_TGEE$coord, permutation_number=1000)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: Active Enhancer"
#[1] "Enrichment: 1; Depletion 1; Feature: Distal Intergenic"
...
#[1] "Enrichment: 1; Depletion 1; Feature: Downstream"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
#[1] "Enrichment: 1; Depletion 0.92; Feature: Active Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: Poised Enhancer"
```
...
#getting the number of hits in each genomic context for EE downregulated peaks
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% EE_set14_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
...
#[4] "Downstream"      "Exon"            "Poised Enhancer"
loc_summary <- c(loc_summary, "3' UTR"=0,"5' UTR"=0,"Exon"=0, "Downstream" =0, "Active Promoter"=0, "Poised Enhancer"=0)
loc_summary <- loc_summary[match(rownames(locations_ChIP), names(loc_summary))]
...
#getting the number of hits in each genomic context for EE upregulated peaks
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% EE_set14_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#Active Promoter          Intron        Promoter 
#              1               5               1 
...
#[7] "Poised Enhancer" 
loc_summary <- c(loc_summary,"3' UTR"=0, "5' UTR"=0,"Active Enhancer"=0,"Distal Intergenic"=0, "Downstream"=0,"Exon"=0, "Poised Enhancer"=0)
loc_summary <- loc_summary[match(rownames(locations_ChIP), names(loc_summary))]
...
ggplot(locations_norm, aes(x=Name, y=real_count, fill=K4me1_change)) + geom_bar(stat="identity", position="dodge") + theme_bw() + ylab("Number of Peaks") + scale_fill_manual(values=c("palegreen2", "palegreen4"), name="H3K4me1_change") + geom_hline(yintercept=0) + theme(panel.grid.major.x = element_blank(), axis.text.x = element_text(angle=90, hjust=1, size=12), axis.text.y=element_text(size=12), axis.title.x=element_blank()) + ggtitle("Gene Features") + ylim(c(min,max))
```
...
#"set8" (9 genes)
EE_peaks_set8 <- H3K4me1_WTEE_TGEE[H3K4me1_WTEE_TGEE$FDR<=0.05 & abs(H3K4me1_WTEE_TGEE$Fold)>=0.5 & H3K4me1_WTEE_TGEE$SYMBOL %in% set8,]
write.csv(EE_peaks_set8, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/8-multi_omic_integration/overlap/EE_H3K4me1_with_H3K4me3_H3K27ac.csv", row.names=F)

length(EE_set8_down <- EE_peaks_set8[EE_peaks_set8$Fold<0,"coord"]) #16
length(EE_set8_up <- EE_peaks_set8[EE_peaks_set8$Fold>0,"coord"]) #6

##Peaks differentially bound in SE - H3K4me1 gain (with H3K27ac, DNAhm changes)
K4me1_Gene_permutation_enrichment(EE_set8_up, background.peaks=H3K4me1_WTEE_TGEE$coord, permutation_number=1000)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: Distal Intergenic"
#[1] "Enrichment: 0.1; Depletion 1; Feature: Intron"
#[1] "Enrichment: 1; Depletion 1; Feature: Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: Exon"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: Downstream"
...
##Peaks differentially bound in EE - H3K4me1 loss (with H3K4me1, DNAhm changes)
K4me1_Gene_permutation_enrichment(EE_set8_down, background.peaks=H3K4me1_WTEE_TGEE$coord, permutation_number=1000)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: Active Enhancer"
#[1] "Enrichment: 1; Depletion 1; Feature: Active Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: Distal Intergenic"
...
#getting the number of hits in each genomic context for EE downregulated peaks
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% EE_set8_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#  Active Enhancer   Active Promoter Distal Intergenic            Intron 
#                2                 3                 3                 5 
#  Poised Enhancer 
#                3 
...
#add to dataframe
rownames(locations_ChIP)[-which(rownames(locations_ChIP) %in% names(loc_summary))]
#[1] "3' UTR"     "5' UTR"     "Downstream" "Exon"       "Promoter" 
loc_summary <- c(loc_summary, "3' UTR"=0,"5' UTR"=0,"Exon"=0, "Downstream" =0, "Promoter"=0)
loc_summary <- loc_summary[match(rownames(locations_ChIP), names(loc_summary))]
...
#getting the number of hits in each genomic context for EE upregulated peaks
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% EE_set8_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
...
#[5] "Downstream"      "Exon"            "Poised Enhancer" "Promoter" 
loc_summary <- c(loc_summary,"3' UTR"=0, "5' UTR"=0,"Active Enhancer"=0, "Active Promoter"=0, "Downstream"=0,"Exon"=0, "Poised Enhancer"=0, "Promoter"=0)
loc_summary <- loc_summary[match(rownames(locations_ChIP), names(loc_summary))]
...
# Genes with changes to H3K4me3, H3K4me1, and DNAhm in EE
```{r}
...
#"set6" (3 genes)
EE_peaks_set6 <- H3K4me1_WTEE_TGEE[H3K4me1_WTEE_TGEE$FDR<=0.05 & abs(H3K4me1_WTEE_TGEE$Fold)>=0.5 & H3K4me1_WTEE_TGEE$SYMBOL %in% set6,]
write.csv(EE_peaks_set6, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/8-multi_omic_integration/overlap/EE_H3K4me1_with_H3K4me3_DNAhm.csv", row.names=F)
length(EE_set6_down <- EE_peaks_set6[EE_peaks_set6$Fold<0,"coord"]) #3
length(EE_set6_up <- EE_peaks_set6[EE_peaks_set6$Fold>0,"coord"]) #0

##Peaks differentially bound in EE - H3K4me1 gain (with H3K27ac, DNAhm changes)
K4me1_Gene_permutation_enrichment(EE_set8_down, background.peaks=H3K4me1_WTEE_TGEE$coord, permutation_number=1000)
```
...
#getting the number of hits in each genomic context for EE downregulated peaks
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% EE_set6_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#  Active Enhancer Distal Intergenic          Promoter 
#                1                 1                 1 

#add to dataframe
rownames(locations_ChIP)[-which(rownames(locations_ChIP) %in% names(loc_summary))]
#[1] "3' UTR"          "5' UTR"          "Active Promoter" "Downstream"     
#[5] "Exon"            "Intron"          "Poised Enhancer"
loc_summary <- c(loc_summary, "3' UTR"=0,"5' UTR"=0,"Exon"=0, "Downstream" =0, "Active Promoter"=0, "Intron"=0, "Poised Enhancer"=0)
loc_summary <- loc_summary[match(rownames(locations_ChIP), names(loc_summary))]
...
locations_norm_down$Name <- gsub("1","",locations_norm_down$Name)
...
ggplot(locations_norm_down, aes(x=Name, y=real_count, fill=K4me1_change)) + geom_bar(stat="identity", position="dodge") + theme_bw() + ylab("Number of Peaks") + scale_fill_manual(values=c("palegreen2", "palegreen4"), name="H3K4me1_change") + geom_hline(yintercept=0) + theme(panel.grid.major.x = element_blank(), axis.text.x = element_text(angle=90, hjust=1, size=12), axis.text.y=element_text(size=12), axis.title.x=element_blank()) + ggtitle("Gene Features") + ylim(c(min,max))
```
...
SE_peaks_set24 <- H3K4me1_WTSE_TGSE[H3K4me1_WTSE_TGSE$FDR<=0.05 & abs(H3K4me1_WTSE_TGSE$Fold)>=0.5 & H3K4me1_WTSE_TGSE$SYMBOL %in% set24,]
length(SE_set24_down <- SE_peaks_set24[SE_peaks_set24$Fold<0,"coord"]) #722
length(SE_set24_up <- SE_peaks_set24[SE_peaks_set24$Fold>0,"coord"]) #149

##Peaks differentially bound in SE - H3K4me1 gain (with H3K27ac changes)
K4me1_Gene_permutation_enrichment(SE_set24_up, background.peaks=H3K4me1_WTSE_TGSE$coord, permutation_number=1000)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
#[1] "Enrichment: 1; Depletion 0; Feature: Active Enhancer"
...
#[1] "Enrichment: 1; Depletion 1; Feature: Distal Intergenic"
#[1] "Enrichment: 0.8; Depletion 1; Feature: Exon"
#[1] "Enrichment: 0; Depletion 1; Feature: Intron"
#[1] "Enrichment: 1; Depletion 0.05; Feature: Poised Enhancer"
#[1] "Enrichment: 1; Depletion 0.75; Feature: Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: Downstream"

##Peaks differentially bound in SE - H3K4me1 loss (with H3K27ac changes)
K4me1_Gene_permutation_enrichment(SE_set24_down, background.peaks=H3K4me1_WTSE_TGSE$coord, permutation_number=1000)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: Active Enhancer"
...
#[1] "Enrichment: 0; Depletion 1; Feature: Intron"
#[1] "Enrichment: 1; Depletion 0; Feature: Poised Enhancer"
#[1] "Enrichment: 1; Depletion 0; Feature: Promoter"
#[1] "Enrichment: 1; Depletion 0.17; Feature: Downstream"
```
...
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% SE_peaks_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
...
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% SE_peaks_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
...
#incr: active enhancer ***, active promoter *, intron ***, poised enhancer *
#dcr: active promoter ***, intron ***, poised enhancer ***, promoter ***
...
#gene ontology
library(gprofiler2)
gr_H3K4me1 <- gost(query = set24, organism = "mmusculus", ordered_query = FALSE, multi_query = FALSE, significant = TRUE, exclude_iea = FALSE, user_threshold = 0.05, correction_method = "fdr", domain_scope = "custom_annotated", custom_bg=unique(H3K4me1_WTSE_TGSE$SYMBOL[H3K4me1_WTSE_TGSE$SYMBOL %in% H3K27ac_WTSE_TGSE$SYMBOL]), sources = NULL, evcodes=TRUE)$result
...
EE_peaks_set22 <- H3K4me1_WTEE_TGEE[H3K4me1_WTEE_TGEE$FDR<=0.05 & abs(H3K4me1_WTEE_TGEE$Fold)>=0.5 & H3K4me1_WTEE_TGEE$SYMBOL %in% set22,]
length(EE_set22_down <- EE_peaks_set22[EE_peaks_set22$Fold<0,"coord"]) #594
length(EE_set22_up <- EE_peaks_set22[EE_peaks_set22$Fold>0,"coord"]) #307

##Peaks differentially bound in EE - H3K4me1 gain (with H3K27ac changes)
K4me1_Gene_permutation_enrichment(EE_set22_up, background.peaks=H3K4me1_WTEE_TGEE$coord, permutation_number=1000)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
#[1] "Enrichment: 1; Depletion 0; Feature: Active Enhancer"
...
##Peaks differentially bound in EE - H3K4me1 loss (with H3K27ac changes)
K4me1_Gene_permutation_enrichment(EE_set22_down, background.peaks=H3K4me1_WTEE_TGEE$coord, permutation_number=1000)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
#[1] "Enrichment: 0.46; Depletion 1; Feature: 5' UTR"
#[1] "Enrichment: 1; Depletion 0; Feature: Active Enhancer"
#[1] "Enrichment: 1; Depletion 0; Feature: Active Promoter"
#[1] "Enrichment: 0.57; Depletion 1; Feature: Distal Intergenic"
#[1] "Enrichment: 1; Depletion 1; Feature: Downstream"
#[1] "Enrichment: 0.49; Depletion 1; Feature: Exon"
#[1] "Enrichment: 0; Depletion 1; Feature: Intron"
#[1] "Enrichment: 1; Depletion 0.66; Feature: Poised Enhancer"
#[1] "Enrichment: 1; Depletion 0.14; Feature: Promoter"
```
...
#getting the number of hits in each genomic context for SE downregulated peaks
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% EE_set22_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#           3' UTR            5' UTR   Active Enhancer   Active Promoter Distal Intergenic        Downstream 
#                8                 5                68                39                87                 3 
...
#getting the number of hits in each genomic context for SE upregulated peaks
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% EE_set22_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#           3' UTR            5' UTR   Active Enhancer   Active Promoter Distal Intergenic        Downstream 
#                7                 1                21                13                43                 1 
...
#gene ontology
library(gprofiler2)
gr_H3K4me1 <- gost(query = set22, organism = "mmusculus", ordered_query = FALSE, multi_query = FALSE, significant = TRUE, exclude_iea = FALSE, user_threshold = 0.05, correction_method = "fdr", domain_scope = "custom_annotated", custom_bg=unique(H3K4me1_WTSE_TGSE$SYMBOL[H3K4me1_WTSE_TGSE$SYMBOL %in% H3K27ac_WTSE_TGSE$SYMBOL]), sources = NULL, evcodes=TRUE)$result
summary(as.factor(gr_H3K4me1$source))
#GO:BP GO:CC GO:MF    HP  KEGG  REAC    TF    WP 
#  244    85    28     3    27     2    99     1 
...
background_RNA <- H3K4me1_WTSE_TGSE[H3K4me1_WTSE_TGSE$ENSEMBL %in% rownames(nCounts_mnc50),"coord"] #8,6359 peaks (far less!)
...
DEG_peaks <- H3K4me1_WTSE_TGSE[H3K4me1_WTSE_TGSE$coord %in% peak_list & H3K4me1_WTSE_TGSE$ENSEMBL %in% ensgene_hits,] #105 peaks
DEG_peaks_down <- DEG_peaks[DEG_peaks$Fold<0,"coord"] #86
DEG_peaks_up <- DEG_peaks[DEG_peaks$Fold>0,"coord"] #19

K4me1_Gene_permutation_enrichment(DEG_peaks_up, background_RNA, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
...
K4me1_Gene_permutation_enrichment(DEG_peaks_down, background_RNA, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
...
#getting the number of hits in each genomic context for SE downregulated peaks
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% DEG_peaks_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
...
#getting the number of hits in each genomic context for SE upregulated peaks
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% DEG_peaks_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
...
bg_RNA <- H3K4me1_WTSE_TGSE[H3K4me1_WTSE_TGSE$coord %in% background_RNA,]
H3K4me1_gr <- GRanges(seqnames=bg_RNA$seqnames, ranges=IRanges(start=bg_RNA$start, end=bg_RNA$end))
H3K4me1_RRBS <- as.data.frame(subsetByOverlaps(H3K4me1_gr, RRBS_gr))
background_RNA_hmC <- paste(H3K4me1_RRBS$seqnames, paste(H3K4me1_RRBS$start, H3K4me1_RRBS$end, sep="-"), sep=": ") #3,543 peaks

#differentially hydroxymethylated sites
H3K4me1_RNA_gr <- GRanges(seqnames=DEG_peaks$seqnames, ranges=IRanges(start=DEG_peaks$start, end=DEG_peaks$end))
...
H3K4me1_RNA_hmC <- as.data.frame(subsetByOverlaps(H3K4me1_RNA_gr, hmC_gr)) #only two peaks!
...
K4me1_Gene_permutation_enrichment(DHMG_peaks_up, background_RNA_hmC, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
...
K4me1_Gene_permutation_enrichment(DHMG_peaks_down, background_RNA_hmC, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: Active Enhancer"
#[1] "Enrichment: 1; Depletion 1; Feature: Active Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: Distal Intergenic"
...
#getting the number of hits in each genomic context for SE downregulated peaks
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% DHMG_peaks_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
...
#getting the number of hits in each genomic context for SE upregulated peaks
locations <- Gene_K4me1_Relations[Gene_K4me1_Relations$coord %in% DHMG_peaks_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
...
#Plotting genomic context enrichment, sites with increased H3K4me1
