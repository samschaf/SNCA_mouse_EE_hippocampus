...
K27ac_all$up_4kb <- K27ac_all$start-4000
K27ac_all$down_4kb <- K27ac_all$end+4000

library(GenomicRanges)
K27ac_4kb_gr <- GRanges(seqnames=K27ac_all$seqnames, ranges=IRanges(start=K27ac_all$up_4kb, end=K27ac_all$down_4kb), mcols=K27ac_all[,2:10])
K4me1_all_gr <- GRanges(seqnames=K4me1_all$seqnames, ranges=IRanges(start=K4me1_all$start, end=K4me1_all$end), mcols=K4me1_all[,4:11])

K4me1_K27ac <- as.data.frame(subsetByOverlaps(K4me1_all_gr, K27ac_4kb_gr))
K4me1_K27ac <- K4me1_K27ac[,c(1:5,8:13)]
colnames(K4me1_K27ac)[6:11] <- sapply(colnames(K4me1_K27ac)[6:11], function(x) unlist(strsplit(x, split="mcols."))[2])

K4me1_K27ac$coords <- paste(K4me1_K27ac$seqnames, paste(K4me1_K27ac$start, K4me1_K27ac$end, sep="-"), sep=": ")
K4me1_all$coords <- paste(K4me1_all$seqnames, paste(K4me1_all$start, K4me1_all$end, sep="-"), sep=": ")
K4me1_all$K27ac_4kb <- (K4me1_all$coords %in% K4me1_K27ac$coords)

#Subsetting to enhancers
#Poised vs active
nrow(enhancers_poised <- K4me1_all[K4me1_all$TSS_2kb==FALSE & K4me1_all$K27ac_4kb==FALSE,]) #9,804
nrow(enhancers_active <- K4me1_K27ac[K4me1_K27ac$TSS_2kb==FALSE,]) #22,582

write.table(enhancers_poised, file="~/KoborLab/kobor_space/sschaffner/DecipherPD_RRBS/SNCA_OE/Hippocampus/12m_EE/ChIPseq/Zinah_Wassouf_data/consensus_peaks/enhancers_poised.txt", sep="\t")
write.table(enhancers_active, file="~/KoborLab/kobor_space/sschaffner/DecipherPD_RRBS/SNCA_OE/Hippocampus/12m_EE/ChIPseq/Zinah_Wassouf_data/consensus_peaks/enhancers_active.txt", sep="\t")
