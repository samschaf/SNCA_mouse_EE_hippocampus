...
nrow(promoters <- K27ac_all[K27ac_all$TSS_2kb==TRUE,]) #13,912

write.table(promoters, file="~/KoborLab/kobor_space/sschaffner/DecipherPD_RRBS/SNCA_OE/Hippocampus/12m_EE/ChIPseq/Zinah_Wassouf_data/consensus_peaks/promoters.txt", sep="\t")
