# Characterizing peaks with H3K4me3 changes by gene feature
### Samantha Schaffner
### Apr 11, 2022
...
##Permutation test
```{r}
#First, read in background annotation data frame with all of the sites you tested for differential H3K4me3 and their gene contexts (NOT K4me3 island contexts)
#This should be named "Gene_K4me3_Relations"

Gene_K4me3_Relations <- read.csv("/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/7-ChIPseq/Zinah_Wassouf_data/diffbind_2_reps_all_conspeaks/H3K4me3/H3K4me3_WTSE-TGSE_anno.csv")
Gene_K4me3_Relations <- Gene_K4me3_Relations[,c("seqnames","start","end","coord","annotation")]
#remove transcript details from annotation
Gene_K4me3_Relations$annotation[grep("Intron", Gene_K4me3_Relations$annotation)] <- "Intron"
Gene_K4me3_Relations$annotation[grep("Exon", Gene_K4me3_Relations$annotation)] <- "Exon"
Gene_K4me3_Relations$annotation[grep("Promoter", Gene_K4me3_Relations$annotation)] <- "Promoter"
Gene_K4me3_Relations$annotation[grep("Downstream", Gene_K4me3_Relations$annotation)] <- "Downstream"
unique(Gene_K4me3_Relations$annotation)
...
Gene_K4me3_gr <- GRanges(seqnames=Gene_K4me3_Relations$seqnames, ranges=IRanges(start=Gene_K4me3_Relations$start, end=Gene_K4me3_Relations$end))
...
Gene_K4me3_promoters <- subsetByOverlaps(Gene_K4me3_gr, promoters_gr)
nrow(Gene_K4me3_promoters <- as.data.frame(Gene_K4me3_promoters)) #13,477 peaks
Gene_K4me3_promoters$coord <- paste(Gene_K4me3_promoters$seqnames, paste(Gene_K4me3_promoters$start, Gene_K4me3_promoters$end, sep="-"), sep=": ")
Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% Gene_K4me3_promoters$coord,"annotation"] <- "Active Promoter"
...
Gene_K4me3_enpoised <- subsetByOverlaps(Gene_K4me3_gr, enpoised_gr)
nrow(Gene_K4me3_enpoised <- as.data.frame(Gene_K4me3_enpoised)) #1,692 peaks
Gene_K4me3_enpoised$coord <- paste(Gene_K4me3_enpoised$seqnames, paste(Gene_K4me3_enpoised$start, Gene_K4me3_enpoised$end, sep="-"), sep=": ")
Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% Gene_K4me3_enpoised$coord,"annotation"] <- "Poised Enhancer"
...
Gene_K4me3_enactive <- subsetByOverlaps(Gene_K4me3_gr, enactive_gr)
nrow(Gene_K4me3_enactive <- as.data.frame(Gene_K4me3_enactive)) #5,937 peaks
Gene_K4me3_enactive$coord <- paste(Gene_K4me3_enactive$seqnames, paste(Gene_K4me3_enactive$start, Gene_K4me3_enactive$end, sep="-"), sep=": ")
Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% Gene_K4me3_enactive$coord,"annotation"] <- "Active Enhancer"

summary(as.factor(Gene_K4me3_Relations$annotation))
#           3' UTR            5' UTR   Active Enhancer   Active Promoter Distal Intergenic        Downstream 
#              192                49              5937             13024              7354               143 
#             Exon            Intron   Poised Enhancer          Promoter 
#              830              1981              1692              5316 

##### Permutation P value and fold change plot
source('/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/7-ChIPseq/Zinah_Wassouf_data/diffbind_2_reps_all_conspeaks/H3K4me3/K4me3_Gene_permutation_enrichment.R')

#running the permutation: specify inputs
H3K4me3_WTSE_TGSE <- read.csv("/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/7-ChIPseq/Zinah_Wassouf_data/diffbind_2_reps_all_conspeaks/H3K4me3/H3K4me3_WTSE-TGSE_anno.csv")
...
peak_list <- H3K4me3_WTSE_TGSE[H3K4me3_WTSE_TGSE$FDR<=0.05 & abs(H3K4me3_WTSE_TGSE$Fold)>=0.5,"coord"] #9 differentially bound peaks
...
#[1] "Enrichment: 1; Depletion 0.18; Feature: Active Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: Poised Enhancer"

##Peaks only differentially bound in SE ("rescue")
H3K4me3_WTEE_TGEE <- read.csv("/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/7-ChIPseq/Zinah_Wassouf_data/diffbind_2_reps_all_conspeaks/H3K4me3/H3K4me3_WTEE-TGEE_anno.csv")
#removing Gulp1 (SNCA integration site)
H3K4me3_WTEE_TGEE <- H3K4me3_WTEE_TGEE[-which(H3K4me3_WTEE_TGEE$FDR==min(H3K4me3_WTEE_TGEE$FDR)),]

EE_peaks <- H3K4me3_WTEE_TGEE[H3K4me3_WTEE_TGEE$FDR<=0.05 & abs(H3K4me3_WTEE_TGEE$Fold)>=0.5,"coord"] #201 differentially bound peaks
EE_peaks_down <- H3K4me3_WTEE_TGEE[H3K4me3_WTEE_TGEE$FDR<=0.05 & H3K4me3_WTEE_TGEE$Fold<=-0.5,"coord"] #162 peaks
EE_peaks_up <- H3K4me3_WTEE_TGEE[H3K4me3_WTEE_TGEE$FDR<=0.05 & H3K4me3_WTEE_TGEE$Fold>=0.5,"coord"] #39 peaks

SE_peaks <- peak_list #9 differentially bound peaks
SE_peaks_down <- H3K4me3_WTSE_TGSE[H3K4me3_WTSE_TGSE$FDR<=0.05 & H3K4me3_WTSE_TGSE$Fold<=-0.5,"coord"] #4 peaks
SE_peaks_up <- H3K4me3_WTSE_TGSE[H3K4me3_WTSE_TGSE$FDR<=0.05 & H3K4me3_WTSE_TGSE$Fold>=0.5,"coord"] #5 peaks

K4me3_Gene_permutation_enrichment(SE_peaks_up, background.peaks, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: Active Enhancer"
#[1] "Enrichment: 1; Depletion 1; Feature: Distal Intergenic"
#[1] "Enrichment: 1; Depletion 1; Feature: Intron"
#[1] "Enrichment: 1; Depletion 0.27; Feature: Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: Exon"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: Downstream"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
...
K4me3_Gene_permutation_enrichment(SE_peaks_down, background.peaks, permutation_number)
#all p-values = 1
```

#Plotting genomic context enrichment for SE peaks
Split by increased vs decreased H3K4me3.
...
#background
summary <- summary(as.factor(Gene_K4me3_Relations$annotation))
summary
#           3' UTR            5' UTR   Active Enhancer   Active Promoter Distal Intergenic        Downstream 
#              192                49              5937             13024              7354               143 
#             Exon            Intron   Poised Enhancer          Promoter 
...
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% SE_peaks_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#Distal Intergenic          Promoter 
#                2                 2 
names(summary)[-which(names(summary) %in% names(loc_summary))]
#[1] "3' UTR"          "5' UTR"          "Active Enhancer" "Active Promoter" "Downstream"     
#[6] "Exon"            "Intron"          "Poised Enhancer"
loc_summary <- c(loc_summary,  "3' UTR" =0,         "5' UTR"  =0,        "Active Enhancer"=0, "Active Promoter"=0, "Downstream"    =0, 
 "Exon"  =0,          "Intron"  =0,        "Poised Enhancer"=0)
...
locations_norm_down$K4me3_change <- "Decrease"
```
...
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% SE_peaks_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#  Active Enhancer Distal Intergenic            Intron 
#                2                 2                 1 

names(summary)[-which(names(summary) %in% names(loc_summary))]
#[1] "3' UTR"          "5' UTR"          "Active Promoter" "Downstream"      "Exon"           
#[6] "Poised Enhancer" "Promoter" 
loc_summary <- c(loc_summary,  "3' UTR"  =0,        "5' UTR"  =0,        "Active Promoter"=0, "Downstream"=0,      "Exon"=0,           "Poised Enhancer"=0, "Promoter"=0 )
loc_summary <- loc_summary[match(rownames(locations_ChIP), names(loc_summary))]
...
locations_norm_up$K4me3_change <- "Increase"
```

#Plotting gene feature enrichment
Will go with counts due to the low number of peaks.
...
ggplot(locations_norm, aes(x=Name, y=real_count, fill=K4me3_change)) + geom_bar(stat="identity", position="dodge") + theme_bw() + ylab("Number of Peaks") + scale_fill_manual(values=c("gray75", "gray48"), name="H3K4me3_change") + geom_hline(yintercept=0) + theme(panel.grid.major.x = element_blank(), axis.text.x = element_text(angle=90, hjust=1, size=12), axis.text.y=element_text(size=12), axis.title.x=element_blank()) + ggtitle("Gene Features") + ylim(c(0,max))
```

# Genes with altered H3K4me3, H3K4me1, and H3K27ac in EE
```{r}
...
EE_peaks_set8 <- H3K4me3_WTEE_TGEE[H3K4me3_WTEE_TGEE$FDR<=0.05 & abs(H3K4me3_WTEE_TGEE$Fold)>=0.5 & H3K4me3_WTEE_TGEE$SYMBOL %in% set8,]
write.csv(EE_peaks_set8, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/8-multi_omic_integration/overlap/EE_H3K4me3_with_H3K4me1_H3K27ac.csv", row.names=F)

length(EE_set8_down <- EE_peaks_set8[EE_peaks_set8$Fold<0,"coord"]) #6
length(EE_set8_up <- EE_peaks_set8[EE_peaks_set8$Fold>0,"coord"]) #2

K4me3_Gene_permutation_enrichment(EE_set8_up, background.peaks, permutation_number)

K4me3_Gene_permutation_enrichment(EE_set8_down, background.peaks, permutation_number)
#all p-values = 1
```

#Plotting genomic context enrichment for EE peaks
Split by increased vs decreased H3K4me3.
...
#getting the number of hits in each genomic context for SE downregulated peaks
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% EE_set8_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#  Active Enhancer   Active Promoter Distal Intergenic   Poised Enhancer 
#                2                 2                 1                 1 
names(summary)[-which(names(summary) %in% names(loc_summary))]
#[1] "3' UTR"     "5' UTR"     "Downstream" "Exon"       "Intron"    
#[6] "Promoter"  
...
#getting the number of hits in each genomic context for SE upregulated peaks
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% EE_set8_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
...
names(summary)[-which(names(summary) %in% names(loc_summary))]
#[1] "3' UTR"            "5' UTR"            "Active Promoter"  
#[4] "Distal Intergenic" "Downstream"        "Exon"             
#[7] "Intron"            "Poised Enhancer" 
loc_summary <- c(loc_summary,  "3' UTR"  =0,        "5' UTR"  =0,        "Active Promoter"=0, "Distal Intergenic"=0, "Downstream"=0,      "Exon"=0,           "Poised Enhancer"=0, "Intron"=0 )
loc_summary <- loc_summary[match(rownames(locations_ChIP), names(loc_summary))]
...
ggplot(locations_norm, aes(x=Name, y=real_count, fill=K4me3_change)) + geom_bar(stat="identity", position="dodge") + theme_bw() + ylab("Number of Peaks") + scale_fill_manual(values=c("palegreen2", "palegreen4"), name="H3K4me3_change") + geom_hline(yintercept=0) + theme(panel.grid.major.x = element_blank(), axis.text.x = element_text(angle=90, hjust=1, size=12), axis.text.y=element_text(size=12), axis.title.x=element_blank()) + ggtitle("Gene Features") + ylim(c(0,max))
```

# Genes with altered H3K4me3, H3K4me1, and DNAhm in EE
```{r}
...
EE_peaks_set6 <- H3K4me3_WTEE_TGEE[H3K4me3_WTEE_TGEE$FDR<=0.05 & abs(H3K4me3_WTEE_TGEE$Fold)>=0.5 & H3K4me3_WTEE_TGEE$SYMBOL %in% set6,]
write.csv(EE_peaks_set6, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/8-multi_omic_integration/overlap/EE_H3K4me3_with_H3K4me1_DNAhm.csv", row.names=F)
length(EE_set6_down <- EE_peaks_set6[EE_peaks_set6$Fold<0,"coord"]) #2
length(EE_set6_up <- EE_peaks_set6[EE_peaks_set6$Fold>0,"coord"]) #1

K4me3_Gene_permutation_enrichment(EE_set6_up, background.peaks, permutation_number)

K4me3_Gene_permutation_enrichment(EE_set6_down, background.peaks, permutation_number)
#all p-values = 1
```
...
#getting the number of hits in each genomic context for SE downregulated peaks
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% EE_set6_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#Distal Intergenic            Intron 
#                1                 1 
names(summary)[-which(names(summary) %in% names(loc_summary))]
#[1] "3' UTR"          "5' UTR"          "Active Enhancer"
#[4] "Active Promoter" "Downstream"      "Exon"           
#[7] "Poised Enhancer" "Promoter" 
loc_summary <- c(loc_summary,  "3' UTR" =0,         "5' UTR"  =0,  "Downstream"    =0, "Active Enhancer"=0, "Active Promoter"=0, "Poised Enhancer"=0,
 "Exon"  =0,          "Intron"  =0,        "Promoter"=0)
loc_summary <- loc_summary[match(rownames(locations_ChIP), names(loc_summary))]
...
#getting the number of hits in each genomic context for SE upregulated peaks
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% EE_set6_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#Distal Intergenic 
#                1 
...
#[1] "3' UTR"          "5' UTR"          "Active Enhancer"
#[4] "Active Promoter" "Downstream"      "Exon"           
#[7] "Intron"          "Poised Enhancer" "Promoter" 
loc_summary <- c(loc_summary,  "3' UTR"  =0,        "5' UTR"  =0,  "Active Enhancer"=0,      "Active Promoter"=0, "Downstream"=0,      "Exon"=0,           "Poised Enhancer"=0, "Intron"=0 , "Promoter"=0)
loc_summary <- loc_summary[match(rownames(locations_ChIP), names(loc_summary))]
...
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% EE_peaks_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
...
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% EE_peaks_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#  Active Enhancer   Active Promoter Distal Intergenic              Exon            Intron          Promoter 
#                3                 5                15                 2                 7                 7 

names(summary)[-which(names(summary) %in% names(loc_summary))]
#"3' UTR"          "5' UTR"          "Downstream"      "Poised Enhancer"
loc_summary <- c(loc_summary,  "3' UTR"=0,          "5' UTR"=0,          "Downstream"=0,      "Poised Enhancer"=0)
loc_summary <- loc_summary[match(rownames(locations_ChIP), names(loc_summary))]
...
#Plotting gene feature enrichment
```{r plot genomic enrichment, eval=F}
K4me3_Gene_permutation_enrichment(EE_peaks_up, background.peaks, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: Active Enhancer"
#[1] "Enrichment: 1; Depletion 0.01; Feature: Active Promoter"
#[1] "Enrichment: 0.07; Depletion 1; Feature: Distal Intergenic"
#[1] "Enrichment: 1; Depletion 1; Feature: Exon"
#[1] "Enrichment: 0.02; Depletion 1; Feature: Intron"
#[1] "Enrichment: 1; Depletion 1; Feature: Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: Downstream"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
...
K4me3_Gene_permutation_enrichment(EE_peaks_down, background.peaks, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: Active Enhancer"
#[1] "Enrichment: 1; Depletion 0.06; Feature: Active Promoter"
#[1] "Enrichment: 0.51; Depletion 1; Feature: Distal Intergenic"
#[1] "Enrichment: 1; Depletion 1; Feature: Exon"
#[1] "Enrichment: 0.91; Depletion 1; Feature: Intron"
#[1] "Enrichment: 1; Depletion 1; Feature: Poised Enhancer"
#[1] "Enrichment: 1; Depletion 1; Feature: Promoter"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: Downstream"
...
locations_norm$sig <- as.factor(c(NA,NA,NA,"*",NA,NA,NA,"*",rep(NA,12)))
...
ggplot(locations_norm, aes(x=Name, y=fold_change, fill=K4me3_change)) + geom_bar(stat="identity", position="dodge") + theme_bw() + ylab("Fold Change over Background") + scale_fill_manual(values=c("palegreen2", "palegreen4"), name="H3K4me3_change") + geom_hline(yintercept=0) + theme(panel.grid.major.x = element_blank(), axis.text.x = element_text(angle=90, hjust=1, size=12), axis.text.y=element_text(size=12), axis.title.x=element_blank()) + ggtitle("Gene Features") + ylim(c(min,max))  + 
   geom_text(data = subset(locations_norm, fold_change >= 0), 
      aes(Name, fold_change, group=K4me3_change, label=sig),
...
K4me3_Gene_permutation_enrichment(SE_down, background.peaks, permutation_number)
...
K4me3_Gene_permutation_enrichment(SE_up, background.peaks, permutation_number)
...
#getting the number of hits in each genomic context for SE downregulated peaks
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% SE_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#           3' UTR            5' UTR   Active Enhancer   Active Promoter 
#               62                13               477               418 
...
#getting the number of hits in each genomic context for SE upregulated peaks
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% SE_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#           3' UTR            5' UTR   Active Enhancer   Active Promoter 
#               20                 2                32                32 
...
ggplot(locations_norm, aes(x=Name, y=fold_change, fill=K4me3_change)) + geom_bar(stat="identity", position="dodge") + theme_bw() + ylab("Fold Change over Background") + scale_fill_manual(values=c("gray75", "gray48"), name="H3K4me3_change") + geom_hline(yintercept=0) + theme(panel.grid.major.x = element_blank(), axis.text.x = element_text(angle=90, hjust=1, size=12), axis.text.y=element_text(size=12), axis.title.x=element_blank()) + ggtitle("Gene Features") + ylim(c(min,max))  + 
   geom_text(data = subset(locations_norm, fold_change >= 0), 
      aes(Name, fold_change, group=K4me3_change, label=sig),
        position = position_dodge(width=0.9), vjust = 0, size=2) +
    geom_text(data = subset(locations_norm, fold_change < 0), 
      aes(Name, fold_change, group=K4me3_change, label=sig),
        position = position_dodge(width=0.9), vjust = 1.5, size=2)
```
![Gene features fold enrichment for SE-only differentially bound peaks](/home/BCRICWH.LAN/sschaffner/KoborLab/kobor_space/sschaffner/DecipherPD_RRBS/SNCA_OE/Hippocampus/12m_EE/7-ChIPseq/Zinah_Wassouf_data/diffbind_2_reps_all_conspeaks/H3K4me3/SE_only_gene_features.png)

## Peaks only differentially bound in SE ("rescue") - all
```{r}
length(SE_only <- SE_peaks[-which(SE_peaks %in% EE_peaks)]) #3601
K4me3_Gene_permutation_enrichment(SE_only, background.peaks, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
...
##Peaks differentially bound in SE and EE - H3K4me3 loss
length(SE_EE_down <- SE_peaks_down[which(SE_peaks_down %in% EE_peaks_down)]) #862
K4me3_Gene_permutation_enrichment(SE_EE_down, background.peaks, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
#[1] "Enrichment: 1; Depletion 0; Feature: Active Enhancer"
...
##Peaks differentially bound in SE and EE - H3K4me3 gain
length(SE_EE_up <- SE_peaks_up[which(SE_peaks_up %in% EE_peaks_up)]) #178
K4me3_Gene_permutation_enrichment(SE_EE_up, background.peaks, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
...
K4me3_Gene_permutation_enrichment(SE_EE, background.peaks, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
#[1] "Enrichment: 1; Depletion 0; Feature: Active Enhancer"
...
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% SE_EE_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#           3' UTR            5' UTR   Active Enhancer   Active Promoter 
#               13                 5                91               108 
...
#Plotting genomic context enrichment, sites with increased H3K4me3
...
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% SE_EE_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
...
#Plotting gene feature enrichment
H3K4me3 loss and gain will be plotted separately (loss to be its own figure).
```{r plot genomic enrichment, eval=F}
###fold change plot (decreased H3K4me3)
...
ggplot(locations_norm_down, aes(x=Name, y=fold_change,fill=K4me3_change)) + geom_bar(stat="identity", position="dodge") + theme_bw() + ylab("Fold Change over Background") + scale_fill_manual(values=c("plum2"), name="H3K4me3_change") + geom_hline(yintercept=0) + theme(panel.grid.major.x = element_blank(), axis.text.x = element_text(angle=90, hjust=1, size=12), axis.text.y=element_text(size=12), axis.title.x=element_blank()) + ggtitle("Gene Features") + ylim(c(min,max))  + 
...
###fold change plot (increased H3K4me3)
   ...
   geom_text(data = subset(locations_norm_up, fold_change >= 0), 
    ...
    geom_text(data = subset(locations_norm_up, fold_change < 0), 
      aes(Name, fold_change, label=sig),
        position = position_dodge(width=0.9), vjust = 1.5, size=2)
```
![Gene features fold enrichment for SE and EE peaks with decreased H3K4me3](/home/BCRICWH.LAN/sschaffner/KoborLab/kobor_space/sschaffner/DecipherPD_RRBS/SNCA_OE/Hippocampus/12m_EE/7-ChIPseq/Zinah_Wassouf_data/diffbind_2_reps_all_conspeaks/H3K4me3/SE_EE_down_gene_features.png)

![Gene features fold enrichment for SE and EE peaks with increased H3K4me3](/home/BCRICWH.LAN/sschaffner/KoborLab/kobor_space/sschaffner/DecipherPD_RRBS/SNCA_OE/Hippocampus/12m_EE/7-ChIPseq/Zinah_Wassouf_data/diffbind_2_reps_all_conspeaks/H3K4me3/SE_EE_up_gene_features.png)

## Peaks differentially bound in EE only
```{r}
##Peaks differentially bound in EE only - H3K4me3 loss
length(EE_down <- EE_peaks_down[-which(EE_peaks_down %in% SE_peaks_down)]) #2484
K4me3_Gene_permutation_enrichment(EE_down, background.peaks, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
#[1] "Enrichment: 1; Depletion 1; Feature: 3' UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: 5' UTR"
#[1] "Enrichment: 1; Depletion 0; Feature: Active Enhancer"
...
K4me3_Gene_permutation_enrichment(EE_only, background.peaks, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
...
##Peaks differentially bound in EE only - H3K4me3 gain
length(EE_up <- EE_peaks_up[-which(EE_peaks_up %in% SE_peaks_up)]) #1478
K4me3_Gene_permutation_enrichment(EE_up, background.peaks, permutation_number)
#[1] "FDR Adjusted Permutation P values for enrichment and depletion"
...
#getting the number of hits in each genomic context for EE downregulated peaks
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% EE_down,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#           3' UTR            5' UTR   Active Enhancer   Active Promoter 
#               54                 7               257               281 
...
#Plotting genomic context enrichment, peaks with increased H3K4me3
...
#getting the number of hits in each genomic context for EE upregulated peaks
locations <- Gene_K4me3_Relations[Gene_K4me3_Relations$coord %in% EE_up,"annotation"]
loc_summary <- summary(as.factor(locations))
loc_summary
#           3' UTR            5' UTR   Active Enhancer   Active Promoter 
#               39                 5               119               105 
   ...
   geom_text(data = subset(locations_norm, fold_change >= 0), 
    ...
    geom_text(data = subset(locations_norm, fold_change < 0), 
      aes(Name, fold_change, group=K4me3_change, label=sig),
        position = position_dodge(width=0.9), vjust = 1.5, size=2)
```
![Gene features fold enrichment for EE-only differentially bound peaks](/home/BCRICWH.LAN/sschaffner/KoborLab/kobor_space/sschaffner/DecipherPD_RRBS/SNCA_OE/Hippocampus/12m_EE/7-ChIPseq/Zinah_Wassouf_data/diffbind_2_reps_all_conspeaks/H3K4me3/EE_only_gene_features.png)

#Cell type enrichment of hits
Code from Thomas Hentrich (University of Tuebingen).
```{r celltype, eval=F}
#get list of differentially bound genes
WTSE_TGSE_hits <- unique(H3K4me3_WTSE_TGSE[H3K4me3_WTSE_TGSE$FDR<=0.05 & abs(H3K4me3_WTSE_TGSE$Fold)>=0.5,"SYMBOL"])
length(WTSE_TGSE_hits <- WTSE_TGSE_hits[complete.cases(WTSE_TGSE_hits)]) #3437 DB genes
WTSE_TGSE_up <- unique(H3K4me3_WTSE_TGSE[H3K4me3_WTSE_TGSE$FDR<=0.05 & H3K4me3_WTSE_TGSE$Fold>=0.5,"SYMBOL"])
length(WTSE_TGSE_up <- WTSE_TGSE_up[complete.cases(WTSE_TGSE_up)]) #720 DB genes
WTSE_TGSE_down <- unique(H3K4me3_WTSE_TGSE[H3K4me3_WTSE_TGSE$FDR<=0.05 & H3K4me3_WTSE_TGSE$Fold<=-0.5,"SYMBOL"])
...
length(background_genes <- unique(H3K4me3_WTSE_TGSE$SYMBOL[complete.cases(H3K4me3_WTSE_TGSE$SYMBOL)])) #18,245
...
#microglial genes with H3K4me3 loss
...
#microglial genes with H3K4me3 gain
...
```
![Enrichment of cell type related genes in WTSE/TGSE hits](/home/BCRICWH.LAN/sschaffner/KoborLab/kobor_space/sschaffner/DecipherPD_RRBS/SNCA_OE/Hippocampus/12m_EE/7-ChIPseq/Zinah_Wassouf_data/diffbind_2_reps_all_conspeaks/H3K4me3/celltype_WTSE_TGSE.png)

Pyramidal neuron genes have reduced H3K4me3 in TG mice.
