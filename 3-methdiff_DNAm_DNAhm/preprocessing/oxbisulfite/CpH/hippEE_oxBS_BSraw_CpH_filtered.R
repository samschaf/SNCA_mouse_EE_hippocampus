...
save(all_EE, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/preprocessing/oxbisulfite/CpH/all_EE_mC_betas_CpH_10X.RData")
...
oxBS_BSraw_CpH <- BSraw(metadata=metadata, rowRanges=rowRanges, colData=colData, totalReads=as.matrix(total_reads), methReads=as.matrix(meth_reads))

save(oxBS_BSraw_CpH, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/preprocessing/oxbisulfite/CpH/hippEE_oxBS_BSraw_CpH_10X.RData")
