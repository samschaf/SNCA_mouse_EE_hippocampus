...
load("/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/preprocessing/oxbisulfite/CpG/longest_transcript_mC_CpG.RData")
...
length(longest_transcript[complete.cases(longest_transcript)]) #195,445

longest_tx_site <- paste(names(longest_transcript), longest_transcript, sep=".")
nrow(BSraw_anno_sub <- BSraw_anno[BSraw_anno$tx_site %in% longest_tx_site,]) #564,582
length(unique(BSraw_anno_sub$site)) #329,507
length(unique(BSraw_anno$site)) #329,507 - all sites have at least one annotation
...
length(unique_cpgs <- unique(results_anno_multi_genes_sub$site)) #329,507
...
# [1] "mm10_genes_intergenic"           "mm10_cpg_inter"                  "mm10_genes_introns"              "mm10_genes_exons"               
# [5] "mm10_genes_intronexonboundaries" "mm10_genes_exonintronboundaries" "mm10_genes_promoters"            "mm10_cpg_shores"                
# [9] "mm10_genes_1to5kb"               "mm10_genes_5UTRs"                "mm10_genes_firstexons"           "mm10_genes_3UTRs"               
...
nrow(cpg_anno <- data.frame(site=unique_cpgs, gene=specific_gene, tx=specific_tx, genomic_anno=specific_anno)) #329,507
...
nrow(results_nogenes <- BSraw_anno[BSraw_anno$annot.type %in% c("mm10_cpg_inter", "mm10_cpg_islands", "mm10_cpg_shelves", "mm10_cpg_shores"),]) #329,507
...
write.table(cpg_anno, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/preprocessing/oxbisulfite/CpG/cpg_anno_mC.txt", sep="\t")
```
...
# [1] "mm10_genes_intergenic"           "mm10_genes_introns"              "mm10_genes_exons"                "mm10_genes_intronexonboundaries"
# [5] "mm10_genes_exonintronboundaries" "mm10_genes_promoters"            "mm10_genes_1to5kb"               "mm10_genes_5UTRs"               
# [9] "mm10_genes_3UTRs"                "mm10_lncrna_gencode"      
...
#              mm10_genes_1to5kb                mm10_genes_3UTRs                mm10_genes_5UTRs mm10_genes_exonintronboundaries                mm10_genes_exons 
#                           1127                             334                             161                            4323                            2095 
#          mm10_genes_intergenic mm10_genes_intronexonboundaries              mm10_genes_introns            mm10_genes_promoters             mm10_lncrna_gencode 
#                           4673                            1754                           12148                             762                              86 
...
#                            268                              56                              51                            1112                             311 
#          mm10_genes_intergenic mm10_genes_intronexonboundaries              mm10_genes_introns            mm10_genes_promoters             mm10_lncrna_gencode 
#                           2458                             374                            2679                             173                              33 

#promoters
summary(cpg_anno[cpg_anno$site %in% cpg_promoters$mcols,"genomic_anno"])
#              mm10_genes_1to5kb                mm10_genes_3UTRs                mm10_genes_5UTRs mm10_genes_exonintronboundaries                mm10_genes_exons 
#                           3253                            1085                            1235                           10229                            4378 
#          mm10_genes_intergenic mm10_genes_intronexonboundaries              mm10_genes_introns            mm10_genes_promoters             mm10_lncrna_gencode 
#                           2165                            2710                            9213                            4529                             106  
...
unique(cpg_anno$genomic_anno)
# [1] "mm10_genes_intergenic"           "mm10_genes_introns"              "mm10_genes_exons"                "mm10_genes_intronexonboundaries"
# [5] "mm10_genes_exonintronboundaries" "enhancers_poised"                "mm10_genes_1to5kb"               "promoters_active"               
# [9] "mm10_genes_promoters"            "enhancers_active"                "mm10_genes_3UTRs"                "mm10_lncrna_gencode"            
#[13] "mm10_genes_5UTRs"  

write.table(cpg_anno, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/preprocessing/oxbisulfite/CpG/cpg_anno_mC_ChIP.txt", sep="\t")
```
