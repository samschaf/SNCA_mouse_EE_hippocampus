...
length(WTEE_TGEE_hits <- unique(H3K4me1_WTEE_TGEE[H3K4me1_WTEE_TGEE$FDR<=0.05 & abs(H3K4me1_WTEE_TGEE$Fold)>=0.5 & complete.cases(H3K4me1_WTEE_TGEE$SYMBOL),"SYMBOL"]))
#3,635

length(WTEE_TGEE_up <- unique(H3K4me1_WTEE_TGEE[H3K4me1_WTEE_TGEE$FDR<=0.05 & H3K4me1_WTEE_TGEE$Fold>=0.5 & complete.cases(H3K4me1_WTEE_TGEE$SYMBOL),"SYMBOL"]))
#1,427

length(WTEE_TGEE_down <- unique(H3K4me1_WTEE_TGEE[H3K4me1_WTEE_TGEE$FDR<=0.05 & H3K4me1_WTEE_TGEE$Fold<=-0.5 & complete.cases(H3K4me1_WTEE_TGEE$SYMBOL),"SYMBOL"]))
#2,661
...
# caclulate common genes
#idx = na.omit(match(myMap$mgi_symbol , linnarsson$V1))
length(background_genes <- unique(H3K4me1_WTEE_TGEE$SYMBOL[complete.cases(H3K4me1_WTEE_TGEE$SYMBOL)])) #18,245
