...
png("/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/hydroxy/WTSE_WTEE/linear_model/CpG/volcano_GxE_CpG_auto.png", width=305, height=335)
...
results_E$DB <- rowMeans(betas_variable[,5:7]) - rowMeans(betas_variable[,1:4])

write.csv(results_E, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/hydroxy/WTSE_WTEE/linear_model/CpG/lm_WTSE_WTEE_CpG_auto.csv", row.names=F)

png("~/KoborLab/Projects/DecipherPD_mouse/EE_asyn/sschaffner/3-methdiff_DNAm_DNAhm/hydroxy/WTSE_WTEE/linear_model/CpG/volcano_GxE_CpG_auto_manual_DB.png", width=305, height=335)
...
```
![P-value histogram](/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/hydroxy/WTSE_WTEE/linear_model/CpG/pval_hist.png)

![Q-Q plot](/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/hydroxy/WTSE_WTEE/linear_model/CpG/qqplot.png)

![Volcano plot](/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/hydroxy/WTSE_WTEE/linear_model/CpG/volcano_GxE_CpG_auto.png)
...
```{r volcano 1, eval=F}
results_E <- read.csv("/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/hydroxy/WTSE_WTEE/linear_model/CpG/lm_WTSE_WTEE_CpG_auto.csv")
...
write.csv(results_E_complete, file="/mnt/scratch/KoborLab/DecipherPD_mouse/ee_asyn/hipp/sschaffner/082022/5-methdiff_DNAm_DNAhm/hydroxy/WTSE_WTEE/linear_model/CpG/lm_WTSE_WTEE.csv", row.names=F)
```
